...
static func create(sizes: SkeletonSizesUtil, has_neck: bool) -> CustomBonesUtil:
	...
	bones_util.left_hip = CustomBone.createFromToLeft(bones_util.lower_spine, sizes.hip_width, 0.0,0.0, Color.ROYAL_BLUE , false)
	bones_util.right_hip = CustomBone.createFromToRight(bones_util.lower_spine, sizes.hip_width, 0.0,0.0, Color.ROYAL_BLUE , false)
