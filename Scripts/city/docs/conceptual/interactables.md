...
Dashboards arranged as a partial ring against the ship's hull — controllables that move the ship or perform repairs, plus information interactables (manual, phone) and seats. See [ship-gameplay.md](ship-gameplay.md).
