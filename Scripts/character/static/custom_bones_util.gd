...
static func create(sizes: SkeletonSizesUtil, inst: EntityInstantiation) -> CustomBonesUtil:
	...
	bones_util.chest        = CustomBone.createFromToUp(bones_util.upper_spine, sizes.chest_size, sizes.chest_offset, 0.0, -sizes.slouchiness_chest, Color.BURLYWOOD, true)
