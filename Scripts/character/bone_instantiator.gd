...
@export var archetype: EntityArchetype.Archetype = EntityArchetype.Archetype.fat_man
...
func initialize_skeleton() -> void:
	...
	entity_archetype = EntityArchetype.create(archetype)
	skel_sizes_util = SkeletonSizesUtil.create(entity_archetype)
	custom_bones_util = CustomBonesUtil.create(skel_sizes_util, entity_archetype)
...
func _physics_process(_delta: float) -> void:
	...
	skel_sizes_util.update(_delta,char_rigidbody,entity_archetype,ik_util)
