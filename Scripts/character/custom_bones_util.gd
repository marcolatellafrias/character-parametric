...
static func create(sizes: SkeletonSizesUtil, entity_stats: EntityStats) -> CustomBonesUtil:
	...
	bones_util.middle_spine = CustomBone.createFromToUp(bones_util.lower_spine, sizes.middle_spine_size, sizes.middle_spine_offset, 0.0,slouchiness_center_spine, Color.SKY_BLUE, true)
	...
	if entity_stats.has_neck:
		bones_util.neck = CustomBone.createFromToUp(bones_util.chest, sizes.neck_size, sizes.neck_offset, 0.0,-slouchiness_neck, Color.RED , true)
	...
	bones_util.right_shoulder = CustomBone.createFromToRight(bones_util.chest, sizes.shoulder_width, sizes.shoulder_offset, -shoulder_back,shoulder_height, Color.GREEN , true)
	...
	bones_util.right_lower_arm = CustomBone.createFromToDown(bones_util.right_upper_arm, sizes.lower_arm_size, sizes.lower_arm_offset, -lower_arms_openness,0.0, Color.RED , true)
	bones_util.left_lower_arm = CustomBone.createFromToDown(bones_util.left_upper_arm, sizes.lower_arm_size, sizes.lower_arm_offset, lower_arms_openness,0.0, Color.RED , true)
	return bones_util
